...
def get_datetime():
    # 시간의 획득 : 현재시간
    now = datetime.datetime.now() # datetime모듈의 datetime클래스의
    print("현재 날짜 :", now)
